...
source .venv/bin/activate   # .venv\Scripts\activate
                            # python scripts/w1_preprocessing.py data_ingestion --root_path "C:/Users/MensesR/Downloads/Local repo MLOps training - personal/marvelous-databricks-course-rosamenzs" --env dev --is_test 1
                            # python -m pre_commit run --all-files
                            # python -m pytest --cov=src --cov-report=term-missin
```
