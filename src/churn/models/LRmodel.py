...
class LRModel:
    ...
    def __init__(self, config: ProjectConfig, tags: Tags, spark: DatabricksSession) -> None:
        ...
        self.experiment_name = self.config.experiment_name_LR
    ...
    def prepare_features(self) -> None:
        ...
        self.pipeline = Pipeline(
            steps=[("preprocessor", self.preprocessor), ("classification_model", LogisticRegression(**self.parameters))]
        )
    ...
    def log_model(self) -> None:
        ...
        with mlflow.start_run(tags=self.tags) as run:
            ...
            mlflow.log_param("model_type", "LR with preprocessing")
            ...
            mlflow.sklearn.log_model(sk_model=self.pipeline, artifact_path="lr-pipeline-model", signature=signature)
